...
def update(npc_image1, npc_image2, start_time):
    ...
    if not current_race.is_paused:
        ...
        current_race.race_time = update_timer(screen, start_time, (255, 0, 0), (650, 10), font)
        display_laps(screen, player_car.laps, (255, 255, 255), (10, 50), font, 'Player Car', current_race.total_laps)
        display_laps(screen, current_race.objects.cars[1].laps, (255, 255, 255), (10, 10), font,
                     current_race.objects.cars[1].name, current_race.total_laps)
