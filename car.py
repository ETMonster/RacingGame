...
class trial_npc:
    def __init__(self, image, pos, dir, speed, max_angle):
        self.image = image
        self.pos = pos
        self.dir = dir
        self.speed = speed
    ...
    def update_direction(self):  # method that is used to change the car's direction
        ...
        if ray_index == 0:  # this will be the ray coming from the right of the car as its starting angle will be -60 deg
    ...
    def collision_checker(self, inner_points, outer_points):  # method to check collisions
        # if the coordinates of the car is in the list of the inner ellipse points or outer ellipse points, the car will drive backwards
    ...
    def update_intersection(self, wall_segments):  # method to update the intersection of the rays with wall segments
        ...
        for x in wall_segments:
            ...
            if t >= 0 and t <= 1 and u > 0:
                ...
                temp_distance = ((self.pos1[0] - x_intersection) ** 2 + (self.pos1[
                                                                             1] - y_intersection) ** 2) ** 0.5  # calculate distance from starting point of ray to intersection
